...
OurNet_M_J_RA_bd_tpr=[0,0.913,1]
OurNet_M_J_RA_bd_fpr=[0,0.020,1]

OurNet_M_J_RA_tpr=[0,0.92787,1]
OurNet_M_J_RA_fpr=[0,0.03603,1]

OurNet_M_J_tpr=[0,0.88556,1]
OurNet_M_J_fpr=[0,0.03742,1]

UNet_tpr=[0,0.83222,1]
UNet_fpr=[0,0.08133,1]

UNet__tpr=[0,0.92123,1]
UNet__fpr=[0,0.037821,1]

RNet__tpr=[0,0.91243,1]
RNet__fpr=[0,0.045921,1]
...
plt.title('ROC curve of proposed models on the Kvasir_SEG')
